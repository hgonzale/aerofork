...
#include <AQ_SPI\MS5611SPIExt.h>
MS5611SPIExt spiMS5611;
...
//uint32_t volatile _s_D1;
//uint32_t volatile _s_D2;

/*uint8_t volatile _d1_count;
uint8_t volatile _d2_count;
uint8_t _state;
uint32_t _timer;
bool volatile _updated;*/

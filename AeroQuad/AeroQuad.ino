...
//    #define SPARKFUN_5883L_BOB
  ...
  #include <AQ_FlightControlProcessor\controlLoop.h>
  ...
  // heading mag hold declaration
  #define HMC5883L
  #include <AQ_Compass\Magnetometer_HMC5883L.h>
  #define SPARKFUN_9DOF_5883L
  //
  ...
  // Altitude declaration
  #include <AQ_BarometricSensor\BarometricSensor_MS5611.h>
  //
...
void process20HzTask() {
	...
	PIDControl(motorCommand, sensorReadings, G_Dt);

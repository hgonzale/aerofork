...
void matrixTranspose4x4 (float matrixC[16], float matrixA[16]) {
  matrixC[0] = matrixA[0];
  matrixC[1] = matrixA[4];
  matrixC[2] = matrixA[8];
  matrixC[3] = matrixA[12];

  matrixC[4] = matrixA[1];
  matrixC[5] = matrixA[5];
  matrixC[6] = matrixA[9];
  matrixC[7] = matrixA[13];

  matrixC[8] = matrixA[2];
  matrixC[9] = matrixA[6];
  matrixC[10] = matrixA[10];
  matrixC[11] = matrixA[14];

  matrixC[12] = matrixA[3];
  matrixC[13] = matrixA[7];
  matrixC[14] = matrixA[11];
  matrixC[15] = matrixA[15];

}

/*
4x4 Matrix Inverse function taken from the MESA implementation of the GLU library
*/
void matrixInverse4x4(float m[16], float invOut[16]) {
  double inv[16], det;
    int i;
